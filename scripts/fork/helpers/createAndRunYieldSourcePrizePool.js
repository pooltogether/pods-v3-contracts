...
const POOL = require("@pooltogether/pooltogether-contracts/abis/PoolWithMultipleWinnersBuilder")
...
async function createAndRunYieldSourcePrizePool(signer, yieldSourceAddress) {
  const builder = await ethers.getContract('@pooltogether/pooltogether-contracts/abis/PoolWithMultipleWinnersBuilder', signer)
